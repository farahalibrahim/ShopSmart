  ...
  <div class="container">
    ...
    <div class="c">
      ...
      foreach ($results as $result) {
        ...
        echo '<a href="products/viewproduct.php?barcode=' . $result['barcode'] . '"><div class="productcard">';
        ...
        echo '<a href="products/viewproduct.php?barcode=' . $result['barcode'] . '"><span class="material-symbols-outlined" id="catarrow">arrow_forward</span></a>';
        echo '</div></div></a>';
      }
      ?>
    </div>
